	...
	<div>
		...
		<form method="post" class="inform">
			...
			<label><br>Number of rooms available:</label><br>
				<input type="text" pattern = "/^[0-9]{1,2}$/" name="roomAmount"><br><br>
			<label>Address:</label><br>
				<input type="text" pattern = "/^[a-zA-Z0-9 ]{2,50}$/" name="address"><br><br>
			<label>Rent cost per month:</label><br>
				<input type="text" pattern = "/^[0-9]{1,5}$/" name="costMonth"><br><br>
			<label>Utility cost per month:</label><br>
				<input type="text" pattern = "/^[0-9]{1,5}$/" name="costUtil"><br><br>
			<label>Available move in date:</label><br>
				<input type="text" pattern = "/^[0-9]{2}-[0-9]{2}-[0-9]{4}$/" name="availableDate"><br><br>
			<label>Length of lease:</label><br>
				<input type="text" pattern = "/^[0-9]{1,3}$/" name="leaseLength"><br><br>
			<label>Property rules:</label><br>
				<textarea name="rules" pattern = "/^[a-zA-Z0-9!? ]{1,300}$/" rows="10" cols="30"></textarea>
				<br>
				<br>
