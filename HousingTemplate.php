...
<div id = "wrapper">
	...
	<div id = "mainNav">
		<nav>
			<ul>
				...
				<li><a href = "fileName.php"> Other link 1 </a></li>
				<li><a href = "fileName.php"> Other link 2 </a></li>
	...
	<div id = "occupantList">
		...
		<nav>
			<ul>
				<li><a href = "wallace.php"> Wallace McCircus </a></li>
				<li><a href = "alice.php"> Alice Ninnymuggins </a></li>
				<li><a href = "Schmidt.php"> Schmidt Waterwater </a></li>
			</ul>
		</nav>
	</div>
